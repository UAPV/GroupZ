 ...
 */
class gzSecurityFilterCasOptional extends sfBasicSecurityFilter
{
  public function execute ($filterChain)
  {
    // If there is a GET param named "ticket" it may be a CAS login
    if ($this->getContext()->getRequest()->getGetParameter('ticket', null) !== null)
    {
